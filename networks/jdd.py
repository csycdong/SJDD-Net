...
from networks.representation import Representation
from networks.noise_estimator import NoiseEstimator
from networks.color_prior import ColorPrior


class JDDNet(nn.Module):
